    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.03] shadow-2xl"
        >
          <div className="flex shrink-0 items-center justify-between gap-4 border-b border-white/10 bg-white/[0.04] p-5 sm:p-7">
            <div className="flex min-w-0 items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.22em] text-orange-400">
          ...
          <div className="w-full space-y-8 overflow-y-auto p-5 sm:p-7">
            {firstPlace && (
              <div className="relative overflow-hidden rounded-3xl border border-amber-400/25 bg-white/[0.04] p-6 text-center shadow-sm">
                <div className="absolute right-4 top-4 hidden items-center gap-1.5 rounded-full border border-amber-400/25 bg-amber-400/10 px-3 py-1 sm:flex">
                ...
                <div className="mx-auto mb-3 flex h-20 w-20 items-center justify-center rounded-3xl bg-amber-400/10 ring-1 ring-amber-400/25">
                ...
                <p className="mt-1 text-[10px] font-black uppercase tracking-[0.22em] text-amber-300">
                  Zirvenin sahibi
                </p>

                <div className="mx-auto mt-5 grid max-w-md grid-cols-3 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03]">
            ...
            <div className="space-y-4">
              ...
              <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] shadow-sm">
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-left">
                    <thead>
                      <tr className="border-b border-white/10 bg-white/[0.03] text-[10px] uppercase tracking-wider text-slate-500">
                    ...
                    <tbody>
                      {rankedUsers.map((user, index) => {
                        ...
                        return (
                          <tr
                            key={user.id}
                            className={`border-b border-white/[0.06] transition hover:bg-white/[0.07] ${
                              isFirst ? "bg-amber-400/[0.06]" : ""
                            }`}
                          >
                            ...
                            <td className="px-5 py-4 text-center font-black text-orange-400">
                              {user.exacts}
                            </td>
            ...
            <div className="space-y-5 border-t border-white/10 pt-6">
              ...
              {isLoading ? (
                <div className="flex flex-col items-center justify-center gap-3 rounded-3xl border border-white/10 bg-white/[0.04] p-12 text-center">
